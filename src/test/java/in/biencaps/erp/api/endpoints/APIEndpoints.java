package in.biencaps.erp.api.endpoints;
...
public interface APIEndpoints {
	...
	String getAllProjectForAnUserIdEndpoint = baseURL + "/project/get/all/for-employee";
	...
	String getAllTasksForProjectEndpoint = baseURL + "/project/task/get/all";
	String getAllTasksForProjectSearchEndpoint = baseURL + "/project/task/get/all-search";
	String deleteProjectEndpoint = baseURL + "/project/delete";
	...
	String getAllVerificationsEndpoint = baseURL + "/task/verification/get/all";
	String updateVerificationEndpoint = baseURL + "/task/verification/update";
	String deleteVerificationEndpoint = baseURL + "/task/verification/delete";
